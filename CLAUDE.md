...
- **Фаза 1 — «собери»/«билд»:** бамп → гейты и тесты → сборка → гейт дистрибутива → канал
  обновлений → штамп. Артефакт отдаётся владельцу, и на этом **стоп**.
- **Фаза 2 — «публикуй»/«релиз»:** только после явного «гуд» владельца, пощупавшего сборку.
  Публикуются ТЕ ЖЕ артефакты, без пересборки.
