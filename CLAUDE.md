...
Три скрипта, все обязательны перед завершением задачи, каждый падает на реальном нарушении:
...
Четвёртый — **после сборки инсталлятора**, не перед коммитом: `./vibe-plugins/tools/checkVibeDist.sh`
