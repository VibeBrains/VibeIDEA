...
- [ ] Дальше: рендер Markdown в пузырях агента, звуковые уведомления (как в VibeIDE), инкрементальный просмотр аудита в тулвиндоу, exposed-настройки лимитов скана.
