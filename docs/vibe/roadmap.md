...
- [ ] **История чатов (волна C)** — персист тредов в `.vibe/chats/`, «Прошлые чаты» с фильтрами «Этот проект / Все проекты +N», вкладки, пилюля «история ▾», per-tab режим/модель/черновик. Эталон: [references/vibeideUxParity.md](references/vibeideUxParity.md) «Прошлые чаты», «Вкладки чатов».
