...
- [ ] **Лого VibeIDEA** — выбрать с владельцем; можно в духе VibeIDE. Сейчас: `vibeidea.svg`/`vibeidea_16.svg` в `vibeidea-customization/resources`. Подготовить варианты и показать.
