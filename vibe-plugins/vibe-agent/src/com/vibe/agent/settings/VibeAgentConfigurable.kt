...
class VibeAgentConfigurable : Configurable, Configurable.NoScroll {
  ...
  private var autopilotTokens: JBIntSpinner? = null
  ...
  private var slopRuleBudget: JBIntSpinner? = null
  ...
  override fun createComponent(): JComponent {
    ...
    val slopBudget = JBIntSpinner(VibeAgentSettings.slopRuleBudgetSec, VibeAgentSettings.MIN_SLOP_RULE_BUDGET_SEC,
                                  VibeAgentSettings.MAX_SLOP_RULE_BUDGET_SEC)
      .also { slopRuleBudget = it }
    ...
    return FormBuilder.createFormBuilder()
      ...
      .addLabeledComponent(t("settings.agent.slopRuleBudget"), slopBudget)
      .addComponent(hint(t("settings.agent.hint.slopRuleBudgetHint")))
      ...
      .let { form -> com.vibe.agent.settings.SettingsUi.page(form).apply { border = JBUI.Borders.empty() } }
  }

  private fun section(text: String): javax.swing.JComponent = SettingsUi.section(text)

  private fun hint(html: String): javax.swing.JComponent = SettingsUi.hint(html).apply {
  ...
  override fun isModified(): Boolean =
    ...
    autopilotTokens?.number != VibeAgentSettings.autopilotMaxTokens ||
    ...
    slopRuleBudget?.number != VibeAgentSettings.slopRuleBudgetSec ||
  ...
  override fun apply() {
    ...
    autopilotTokens?.let { VibeAgentSettings.autopilotMaxTokens = it.number }
    ...
    slopRuleBudget?.let { VibeAgentSettings.slopRuleBudgetSec = it.number }
