...
object SpendLedger {
  ...
  /**
   * Окно истории для сметы прогона.
   *
   * Месяц, а не сутки: смета по вчерашнему дню зависела бы от того, гоняли ли вчера именно эту
   * роль, — то есть от случайности, а не от опыта.
   */
